...
cur.execute('''CREATE TABLE IF NOT EXISTS death_row_info
    (id INTEGER UNIQUE, last_statement TEXT, last_name TEXT,
     first_name TEXT, headers TEXT, body TEXT)''')

# Pick up where we left off
start = None
cur.execute('SELECT max(id) FROM death_row_info' )
try:
    row = cur.fetchone()
    if row is None :
        start = 0
